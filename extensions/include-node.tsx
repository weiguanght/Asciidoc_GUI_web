...
// Include 组件 - 使用 NodeViewProps
const IncludeComponent: React.FC<NodeViewProps> = ({ node, selected }) => {
...
export const IncludeNode = Node.create({
    ...
    addCommands() {
        return {
            setInclude: (path: string, options?: { levelOffset?: number; lines?: string; tag?: string }) => ({ commands }: { commands: any }) => {
